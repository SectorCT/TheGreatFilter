        ...
        results = [
            {
                ...
                "localStationNumber": station_row["local_station_number"],
                "country": station_row["country"],
                "waterType": station_row["water_type"],
                "waterBodyName": station_row["water_body_name"],
                "mainBasin": station_row["main_basin"],
